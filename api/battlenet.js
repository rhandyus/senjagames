// Vercel Serverless Function for Battle.net accounts
export default async function handler(req, res) {
  ...
  try {
    ...
    // Build LZT Market API URL for Battle.net category
    const baseURL = 'https://prod-api.lzt.market'
    const apiURL = new URL('battlenet', baseURL)
    ...
    console.error('❌ Battle.net API Error:', error)
    res.status(500).json({
