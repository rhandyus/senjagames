...
// Use /api/lzt/discord as alternative via dynamic routing
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const baseURL = 'https://prod-api.lzt.market/discord'
...
export default function handler(req, res) {
  res.status(503).json({
    error: 'Discord API temporarily disabled',
    message:
      'This endpoint is commented out due to Vercel 12 function limit. Use /api/lzt/discord instead.'
  })
}
