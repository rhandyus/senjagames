// Vercel Serverless Function for Fortnite accounts
export default async function handler(req, res) {
  ...
  try {
    ...
    // Build LZT Market API URL for Fortnite category
    const baseURL = 'https://prod-api.lzt.market'
    const apiURL = new URL('fortnite', baseURL)
    ...
    if (fortnite_cosmetics) apiURL.searchParams.append('fortnite_cosmetics', fortnite_cosmetics)
    if (min_level) apiURL.searchParams.append('min_level', min_level)
    if (max_level) apiURL.searchParams.append('max_level', max_level)
