...
// Use /api/lzt/instagram as alternative via dynamic routing
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const baseURL = 'https://prod-api.lzt.market/instagram'
...
export default function handler(req, res) {
  res.status(503).json({
    error: 'Instagram API temporarily disabled',
    message:
      'This endpoint is commented out due to Vercel 12 function limit. Use /api/lzt/instagram instead.'
  })
}
